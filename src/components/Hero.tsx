        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div ref={buttonsRef} className="flex flex-col sm:flex-row gap-2.5 sm:gap-3 justify-center items-center px-2">
            <Button
              ...
              className="w-full sm:w-auto bg-gradient-to-r from-purple-500 to-blue-600 text-white text-sm px-5 sm:px-6 py-2.5 sm:py-3 h-auto group shadow-lg hover:scale-105 transition-all duration-300 hover:shadow-purple-500/30 touch-manipulation"
            >
